...
async function seed() {
  ...
  await db.profiles.upsert({
    where: { email: "mauricio.barragan@wizeline.com" },
    update: {},
    create: {
  ...
  await db.profiles.upsert({
    where: { email: "leslye.patino@wizeline.com" },
    update: {},
    create: {
  ...
  await db.profiles.upsert({
    where: { email: "abraham.galindo@wizeline.com" },
    update: {},
    create: {
      email: "abraham.galindo@wizeline.com",
      firstName: "Abraham",
      preferredName: "Abraham",
      lastName: "Galindo",
      department: "Engineering", 
    },
  });
